const Hero = () => {
  return (
    <div className="relative bg-[url(/hero.png)] sm:min-ph-[25vh] sm:h-[45vh] sm:max-h-[50vh] 
        ...
        <div className="container py-8 sm:py-0 sm:flex justify-between items-center h-full">
            <div className="flex items-center h-full">
                <div>
                    ...
                    <h2 className="text-primaryDark font-bold text-[24px] sm:text-[30px] md:text-[40px] lg:text-[48px] pb-8 leading-tight">Fresh Hand-Picked Vegetables
                      <br />
